...
@section('content')
      ...
      <div class="p-3 bg-white border rounded">
        ...
        <div class="table-responsive" style="min-height:460px;">
          <button type="button" class="btn btn-primary float-right p-1 " data-toggle="modal" data-target="#addCategory"><i class="fa fa-plus"></i> Add New</button>

              <table id="categoryTbl" class="table table-striped table-bordered table-hover "style="width:100%">
                <thead>
                    <tr>
